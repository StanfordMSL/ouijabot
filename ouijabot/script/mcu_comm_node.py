...
def service_enable_current(req):
	if True == req.is_enable:
		ser.write(Wrap_Msg_P("enable_current", 1.0))
	else:
		ser.write(Wrap_Msg_P("enable_current", -1.0))
...
if __name__ == '__main__':
	...
	rospy.Service('enable_imu', Enable_IMU, service_enable_imu)
	rospy.Service('enable_current', Enable_Current, service_enable_current)
